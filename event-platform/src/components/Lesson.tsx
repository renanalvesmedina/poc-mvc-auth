...
export function Lesson(props: LessonProps) {
  ...
  return (
    <a href="" className="group">
      ...
      <div className="rounded border border-gray-500 p-4 mt-2 group-hover:border-green-300">
        <header className="flex items-center justify-between">
          ...
          <span className="text-xs rounded py-[2px] px-2 text-white border border-green-500">
